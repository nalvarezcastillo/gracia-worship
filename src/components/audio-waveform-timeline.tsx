...
export function AudioWaveformTimeline({ buffers, currentTime, duration, grid = null, loopSectionId = null, onSeek, sections = [] }: { buffers: AudioBuffer[]; currentTime: number; duration: number; grid?: MusicalGrid | null; loopSectionId?: string | null; onSeek: (seconds: number) => void; sections?: SongSection[] }) {
