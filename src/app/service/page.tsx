...
export default async function ServicePage() {
  ...
  return (
    <main className="min-h-screen pb-[calc(5rem+env(safe-area-inset-bottom))] pt-4 sm:py-10 lg:py-8">
      <MainContainer className="max-w-5xl">
        <header className="grid grid-cols-[minmax(0,1fr)_auto] items-end gap-x-3 border-b border-white/[0.08] pb-2.5 sm:flex sm:items-end sm:justify-between sm:gap-6 sm:pb-5">
