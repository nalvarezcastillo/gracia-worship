...
export function loadStemBundle(context: AudioContext, stems: PublicSongStem[], options: { label?: string; mode?: LoadMode; policy?: AudioCachePolicy } = {}) {
...
export async function retryStemBundle(context: AudioContext, stems: PublicSongStem[], options: { label?: string; mode?: LoadMode; policy?: AudioCachePolicy } = {}) {
...
function createBundleLoad(context: AudioContext, stems: PublicSongStem[], retained: LoadedStem[], options: { label?: string; mode?: LoadMode; policy?: AudioCachePolicy }, key: string) {
